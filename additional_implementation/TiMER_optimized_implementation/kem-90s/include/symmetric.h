#ifndef TiMER_SYMMETRIC_H
#define TiMER_SYMMETRIC_H
...
#define aes256ctr_xof TiMER_NAMESPACE(aes256ctr_xof)
void aes256ctr_xof(uint8_t *output, size_t out_bytes, const uint8_t *input,
                   size_t in_bytes);

#define sha512_absorb_twice TiMER_NAMESPACE(sha512_absorb_twice)
